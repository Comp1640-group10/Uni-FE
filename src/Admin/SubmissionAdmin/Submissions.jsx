                ...
                {data.map((data) => (
                    <div className='icons' >
                        ...
                        <div className='icon-cate'>
                            <Link to={`/editsubmissions/${data.id}`} onChange={() => setDatatoItem(data.id, data.topicName, data.closureDate, data.finalClosureDate)}> <span title="edit" ><Button><FaEdit /></Button></span></Link>
